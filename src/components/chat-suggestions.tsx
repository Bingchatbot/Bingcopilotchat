...
const helpSuggestions = ['Почему вы не отвечаете на определенные темы', 'Расскажите мне больше о Bing', 'Как Bing использует искусственный интеллект AI?'].map((text) => ({ text }))
  ...
  return currentSuggestions?.length ? (
    <div className="py-6">
      <div className="suggestion-items">
        <button className="rai-button" type="button" aria-label="Что это?" onClick={toggleSuggestions}>
